...
<?php include_once('includes/header.php');?>
        ...
        <<!-- Price Start -->
      <div id="washing-plans-section" class="price">
        <div class="price">
            <div class="container">
                <div class="section-header text-center">
                    <h1>Washing Plans</h1><br>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="price-item">
                            <div class="price-header">
                                <h3>Basic Clean Wash </h3>
                                <h2><span>Rs.</span><strong>500</strong><span>.00</span></h2>
                            </div>
                    ...
                    <div class="col-md-4">
                        <div class="price-item">
                            <div class="price-header">
                                <h3>Ultra Clean Wash</h3>
                                <h2><span>Rs.</span><strong>1700</strong><span>.00</span></h2>
                            </div>
                            <div class="price-body">
                                <ul>
                                    <li><i class="far fa-check-circle"></i>Seats Washing</li>
...
<form method="post">   
  <p>
            <select name="packagetype" required class="form-control">
                ...
                <option value="1">BASIC CLEAN WASH (Rs.500)</option>
                <option value="2">PREMIUM CLEAN WASH (Rs.1000)</option>
                <option value="3">COMPLEX CLEAN WASH (Rs.1700)</option>
              </select>
